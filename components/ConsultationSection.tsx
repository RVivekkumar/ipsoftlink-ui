          ...
          <AnimateOnView direction="left">
            <div>
              ...
              <AnimateOnView direction="up" delay={0.3}>
                <div className="mt-8 md:mt-10 bg-white border border-[#0057FF] rounded-[24px] shadow-xl hover:shadow-2xl transition-all duration-500 p-5 sm:p-6 md:p-8 w-full max-w-[580px]">
          ...
          <AnimateOnView direction="right" delay={0.2}>
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative mt-2 lg:mt-72">
                <div className="w-[280px] h-[280px] sm:w-[360px] sm:h-[360px] md:w-[450px] md:h-[450px] lg:w-[540px] lg:h-[540px] rounded-full bg-[#DCE8FF] flex items-center justify-center animate-pulse">
                  <div className="w-[220px] h-[220px] sm:w-[290px] sm:h-[290px] md:w-[360px] md:h-[360px] lg:w-[430px] lg:h-[430px] rounded-full bg-[#AFCBFF] flex items-center justify-center">
                    <Image
                      ...
                      height={500}
                      priority
                      className="w-[180px] sm:w-[240px] md:w-[300px] lg:w-[380px] h-auto animate-[float_5s_ease-in-out_infinite]"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-8 mt-16 border-t border-[#D7DCE5] pt-10">
          {benefits.map((item, index) => (
            <AnimateOnView
              ...
              delay={index * 0.1}
            >
              <div className="px-4 md:px-6 text-center lg:border-r last:border-r-0 border-[#D7DCE5] transition-all duration-300 hover:-translate-y-2">
