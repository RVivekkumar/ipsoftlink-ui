    ...
    <>
      <section className="pt-48 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full z-0">
          <Image
            src="https://res.cloudinary.com/drxigvlxc/image/upload/v1781417737/Frame_2147225820_kjkjh4.png"
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2">
              <AnimateOnView direction="right">
                <h2 className="text-[42px] lg:text-[56px] font-semibold text-[#1E1E1E] mb-2">
                  About us
                </h2>
              </AnimateOnView>
              <AnimateOnView direction="right" delay={0.1}>
                <h1 className="text-[42px] lg:text-[56px] font-semibold text-[#0052FF] mb-8">
